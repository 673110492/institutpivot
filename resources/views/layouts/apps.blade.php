...
<body>
    ...
    <section class="ftco-section-parallax">
        ...
        <p>Souscrivez à notre Newsletter pour plus d'information concernant notre structure et sa gestion</p>
        <div class="row d-flex justify-content-center mt-5">
        <div class="col-md-8">
        <form action="#" class="subscribe-form">
        <div class="form-group d-flex">
        <input type="text" class="form-control" placeholder="Entrer votre adresse Email">
        <input type="submit" value="Souscire" class="submit px-3">
        </div>
        </form>
        </div>
        </div>
