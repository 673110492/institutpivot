...
<section class="course_details padding_bottom">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-xl-3 col-md-2 col-12" data-aos="fade-up" data-aos-duration="1200">
...
<div id="content" class="site-content">
    <div class="lp-archive-courses">
        <div class="lp-content-area">
            ...
            <ul class="learn-press-courses row" data-layout="list" id="tet">
                @foreach($formations as $item)
                    <li class="post-1026 lp_course col-md-6 mb-4">
                        <div class="course-item">
                            <div class="course-wrap-thumbnail">
                                <a href="{{ route('cours.show', $item->id) }}">
                                    <img class="img-fluid course-img" src="{{ isset($item->photo) ? url('storage/' . $item->photo) : '#' }}" alt="{{ $item->nom }}" loading="lazy" title="{{ $item->nom }}" style="max-width: 600px; height: auto;">
                                </a>
                            </div>
                        ...
                        <div class="course-item">
                            <div class="course-wrap-thumbnail">
                                <a href="/cours/${item.id}">
                                    <img class="img-fluid course-img" src="/storage/${item.photo}" alt="${item.nom}" loading="lazy" title="${item.nom}" style="max-width: 300px; height: auto;">
                                </a>
                            </div>
                            <div class="course-content">
