...
<div class="hero-wrap hero-wrap-2" style="background-image: url('images/bg_2.jpg'); background-attachment:fixed;">
    ...
    <p class="breadcrumbs"><span class="mr-2"><a href="index-2.html">Accueil</a></span> <span class="mr-2"><a href="teacher.html">Formateur</a></span> <span>  Details Formateur</span></p>
    <h1 class="mb-3 bread">Details Formateur</h1>
    </div>
    </div>
    </div>
    </div>
