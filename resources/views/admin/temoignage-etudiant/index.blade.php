...
<div class="card mb-3">
    ...
    <div class="card-body position-relative">
        <div class="row">
            <div class="col-lg-8">
                <h3>Gestion des temoignages etudiant</h3>
                <p class="mb-0"><a href="{{ url('/home') }}">Dashboard</a> / Liste des temoignages etudiant</p>
            </div>
            <br>
            <div class="col-12">
                @if ($errors->any())
...
<div class="card">
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0">Liste des temoignages </h5>
            </div>
            <div class="col-auto align-self-center" style="margin-right: 20px">
                <h5>Total : {{$temoignages->count()}}</h5>
            </div>
                            ...
                            <div class="card-body p-0 pb-3">
                                <div class="d-flex align-items-center justify-content-end my-3">
                                    <div id="bulk-select-replace-element" style="margin-right: 20px">
                                        <button title="Ajout d'un temoignage"  data-bs-toggle="modal" data-bs-target="#ajouttemoignage"  class="btn btn-falcon-success btn-sm">
                                        ...
                                        <table class="table table-striped mb-0 fs--3 overflow-hidden">
                                            <thead class="bg-200 text-900">
                                                <tr>
                                                    ...
                                                    <th class="align-middle" data-sort="email">Formation</th>
                                            ...
                                            <tbody class="list" id="table-orders-body">
                                                ...
                                                <tr class="btn-reveal-trigger">
                                                    ...
                                                    <td class="align-middle email">{{$item->formation->nom}}</td>
                                                    <td class="align-middle adresse">{!! Str::limit($item->description, 20, '...')  !!}</td>
                                                    <td>
                                                        @if ($item->statut == true)
                                                    ...
                                                    <td class="align-middle mr-20">
                                                        <button class="btn btn-falcon-info me-1 mb-1"
                                                            title="Détail d'un temoignage"  data-bs-toggle="modal"
                                                            data-bs-target="#detailtemoignage{{ $item->id }}" type="button"><i
                                                                class="fa fa-eye"></i></button>
                                                        <button class="btn btn-falcon-primary me-1 mb-1" title="Modifier un temoignage" data-bs-toggle="modal"
                                                                data-bs-target="#edittemoignage{{ $item->id }}"
                                                                type="button"><i class="fa fa-pen"></i>
                                                        </button>
                                                        <button class="btn btn-falcon-danger me-1 mb-1" title="Supprimer un temoignage"
                                                        ...
                                                        'id' => $item->id,
                                                        'url' => route('temoignage.delete', $item->id),
                                                        ])
                                                        @include('admin.temoignage-etudiant.statut', [
                                                            'temoignage' => $item,
                                                            'url' => route('temoignage.statut', $item->id),
                                                        ])

                                                    @include('admin.temoignage-etudiant.edit', [
                                                        'temoignage'  => $item,
                                                    ])
                                                    @include('admin.temoignage-etudiant.show', [
                                                        'temoignage'  => $item,
                                                    ])
                                                    </td>
                                                </tr>
    ...
    {{-- MODAL CREATE --}}
    @include('admin.temoignage-etudiant.create')
@endsection
