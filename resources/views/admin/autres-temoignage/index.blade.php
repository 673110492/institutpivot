...
<div class="card mb-3">
    ...
    <div class="card-body position-relative">
        <div class="row">
            <div class="col-lg-8">
                <h3>Gestion des autres temoignages</h3>
                <p class="mb-0"><a href="{{ url('/home') }}">Dashboard</a> / Liste des autres temoignages</p>
            </div>
            <br>
            <div class="col-12">
                @if ($errors->any())
...
<div class="card">
                            ...
                            <div class="card-body p-0 pb-3">
                                <div class="d-flex align-items-center justify-content-end my-3">
                                    <div id="bulk-select-replace-element" style="margin-right: 20px">
                                        <button title="Ajout d'un temoignage"  data-bs-toggle="modal" data-bs-target="#ajoutemoignage"  class="btn btn-falcon-success btn-sm">
                                        ...
                                        <table class="table table-striped mb-0 fs--3 overflow-hidden">
                                            <thead class="bg-200 text-900">
                                                <tr>
                                                    ...
                                                    <th class="align-middle" data-sort="email">Fonction</th>
                                            ...
                                            <tbody class="list" id="table-orders-body">
                                                ...
                                                <tr class="btn-reveal-trigger">
                                                    ...
                                                    <td class="align-middle email">{{$item->fonction}}</td>
                                                    ...
                                                    <td class="align-middle mr-20">
                                                        ...
                                                        'id' => $item->id,
                                                        'url' => route('autre.delete', $item->id),
                                                        ])
                                                        @include('admin.autres-temoignage.statut', [
                                                            'temoignage' => $item,
                                                            'url' => route('autre.statut', $item->id),
                                                        ])

                                                    @include('admin.autres-temoignage.edit', [
                                                        'temoignage'  => $item,
                                                    ])
                                                    @include('admin.autres-temoignage.show', [
                                                        'temoignage'  => $item,
                                                    ])
                                                    </td>
                                                </tr>
    ...
    {{-- MODAL CREATE --}}
    @include('admin.autres-temoignage.create')
@endsection
