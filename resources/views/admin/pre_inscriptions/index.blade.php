...
<div class="card mb-3">
    ...
    <div class="card-body position-relative">
        <div class="row">
            <div class="col-lg-8">
                <h3>Gestion des Pré-Inscriptions </h3>
                <p class="mb-0"><a href="{{ url('/home') }}">Dashboard</a> / Liste des pré-inscrit </p>
            </div>
            <br>
            <div class="col-12">
                @if ($errors->any())
    ...
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0">Liste des pré-inscrit</h5>
            </div>
            <div class="col-auto align-self-center" style="margin-right: 20px">
                <h5>Total : {{$pre_inscriptions->count()}}</h5>
            </div>
                            ...
                            <div class="card-body p-0 pb-3">
                                <div class="d-flex align-items-center justify-content-end my-3">
                                    <div id="bulk-select-replace-element" style="margin-right: 20px"><a
                                            class="btn btn-falcon-success btn-sm" href="{{route('pre_inscription.create')}}"><span class="fas fa-plus"
