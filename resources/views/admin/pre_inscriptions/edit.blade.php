    ...
    <div class="card-body position-relative">
        <div class="row">
            <div class="col-lg-8">
                ...
                <p class="mb-0"><a href="{{ url('/home') }}">Dashboard</a> / Modification d'un Etudiant</p>
            </div>
            <br>
            <div class="col-12">
                @if ($errors->any())
...
<div class="card-header bg-light">
    <div class="row">
        <h4 class="col-md">Modification d'une Etudiant</h4>
...
<form action="{{route('pre_inscription.update',$pre_inscriptions->id)}}" method="POST" accept-charset="UTF-8"
...
<div class="card-footer">
    <center>
        <a class="btn btn-danger m-3" href="{{route('pre_inscription.edit',$pre_inscriptions->id)}}">Annuler</a>
