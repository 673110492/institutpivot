...
<div class="card-header bg-light">
    <div class="row">
        <h4 class="col-md">Modification d'une actualité</h4>
        <div class="d-flex align-items-center justify-content-end col-md">
            <div id="bulk-select-replace-element" style="margin-right: 20px">
                <a href="{{route('blog.index')}}" class="btn btn-secondary "><i class="fas fa-arrow-left"></i> Retour</a>
            </div>
        </div>
    </div>
</div>
<form action="{{route('blog.update',$actualite->id)}}" method="POST" accept-charset="UTF-8"
...
<div class="card-footer">
    <center>
        <a class="btn btn-danger m-3" href="{{route('blog.edit',$actualite->id)}}">Annuler</a>
