                            ...
                            <div class="card-body p-0 pb-3">
                                <div class="d-flex align-items-center justify-content-end my-3">
                                    <div id="bulk-select-replace-element" style="margin-right: 20px">
                                        <a title="Ajout d'une information" href="{{route('blog.create')}}"  class="btn btn-falcon-success btn-sm">
                                                    ...
                                                    <td class="align-middle mr-20">
                                                        <button class="btn btn-falcon-info me-1 mb-1"
                                                            ...
                                                            data-bs-target="#staticBackdrops{{ $item->id }}" type="button"><i
                                                                ...
                                                                <a class="btn btn-falcon-primary me-1 mb-1" href="{{route('blog.edit',$item->id)}}" title="Modifier une information"><i class="fa fa-pen"></i>
                                                                </a>
                                                        ...
                                                        @include('admin.blog.statut', [
                                                            'actualite' => $item,
                                                            'url' => route('blog.statut', $item->id),
                                                        ])
                                                    </td>
                                                </tr>
                                                @empty
