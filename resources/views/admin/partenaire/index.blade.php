    ...
    <div class="card-body position-relative">
        <div class="row">
            <div class="col-lg-8">
                ...
                <p class="mb-0"><a href="{{ url('/home') }}">Dashboard</a> / A propos</p>
            </div>
            <br>
            <div class="col-12">
                @if ($errors->any())
                            ...
                            <div class="card-body p-0 pb-3">
                                <div class="d-flex align-items-center justify-content-end my-3">
                                    <div id="bulk-select-replace-element" style="margin-right: 20px">
                                        <a title="Ajout d'une information" href="{{route('partenaire.create')}}"  class="btn btn-falcon-success btn-sm">
                                        ...
                                        <table class="table table-striped mb-0 fs--3 overflow-hidden">
                                            <thead class="bg-200 text-900">
                                                <tr>
                                                    ...
                                                    <th class="align-middle" data-sort="nom">Email</th>
                                            ...
                                            <tbody class="list" id="table-orders-body">
                                                ...
                                                <tr class="btn-reveal-trigger">
                                                    ...
                                                    <td class="align-middle nom">{!! Str::limit($item->nom, 30, '...')  !!}</td>
                                                    <td class="align-middle nom">{!! Str::limit($item->email, 30, '...')  !!}</td>
                                                    ...
                                                    <td class="align-middle mr-20">
                                                        <button class="btn btn-falcon-info me-1 mb-1"
                                                            ...
                                                            data-bs-target="#detailpropos{{ $item->id }}" type="button"><i
                                                                class="fa fa-eye"></i></button>
                                                        <a class="btn btn-falcon-primary me-1 mb-1" href="{{route('partenaire.edit',$item->id)}}" title="Modifier une information"><i class="fa fa-pen"></i>
                                                        </a>
                                                        ...
                                                        'id' => $item->id,
                                                        'url' => route('partenaire.delete', $item->id),
                                                        ])
                                                        @include('admin.partenaire.statut', [
                                                            'partenaire' => $item,
                                                            'url' => route('partenaire.statut', $item->id),
                                                        ])
