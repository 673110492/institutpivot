...
<div class="card mb-3">
    ...
    <div class="card-body position-relative">
        <div class="row">
            <div class="col-lg-8">
                <h3>Gestion des partenaire</h3>
                <p class="mb-0"><a href="{{ url('/home') }}">Dashboard</a> / Ajout d'une information</p>
            </div>
            <br>
            <div class="col-12">
                @if ($errors->any())
...
<div class="card-header bg-light">
    <div class="row">
        <h4 class="col-md">Ajout d'un nouvelle partenaire</h4>
        <div class="d-flex align-items-center justify-content-end col-md">
            <div id="bulk-select-replace-element" style="margin-right: 20px">
                <a href="{{route('partenaire.index')}}" class="btn btn-secondary "><i class="fas fa-arrow-left"></i> Retour</a>
            </div>
        </div>
    </div>
</div>
<form action="{{route('partenaire.store')}}" method="POST" accept-charset="UTF-8"
class="form-horizontal" enctype="multipart/form-data">
    @csrf
 @include('admin.partenaire.form')
