...
<form action="{{route('partenaire.update',$partenaire->id)}}" method="POST" accept-charset="UTF-8"
...
<div class="card-footer">
    <center>
        <a class="btn btn-danger m-3" href="{{route('partenaire.edit',$partenaire->id)}}">Annuler</a>
