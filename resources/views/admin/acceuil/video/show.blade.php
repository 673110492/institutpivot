                ...
                <div class="bg-light rounded-top-lg py-3 ps-4 pe-6">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <a href="{{ url('name/' . $video->photo) }}" class="glightbox2"
                            ...
                            <img src="{{ url('name/' . $video->photo) }}" alt="user-avatar" class="d-block rounded" height="200"
                    ...
                    <div class="card-body">
                        <div class="widget-content-left">
                            ...
                            <div class="widget-heading opacity-8">
                                <a href="{{ url('name/' . $video->video) }}" class="glightbox2"
                                    data-glightbox='title:Description Bottom; description: You can set the position of the description &lt;a href="http://google.com"&gt;with a link to Google&lt;/a&gt;'>
                                <video src="{{ url('name/' . $video->video) }}" alt="user-avatar" class="d-block rounded" height="200"
