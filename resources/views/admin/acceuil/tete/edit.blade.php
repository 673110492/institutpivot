<div class="modal fade" id="edittete{{ $tete->id }}" data-bs-keyboard="false" data-bs-backdrop="static"
        ...
        <div class="modal-content border-0">
            ...
            <div class="modal-body p-0">
                ...
                <div class="bg-light rounded-top-lg py-3 ps-4 pe-6">
                    <h4 class="mb-1" id="edittete{{ $tete->id }}Label">Modification d'une en tete
                    </h4>
                    {{-- <p class="fs--2 mb-0">Added by <a class="link-600 fw-semi-bold" href="#!">Antony</a></p> --}}
                </div>


                <form method="POST" action="{{ route('tete.update', $tete->id) }}" accept-charset="UTF-8"
                    class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    @include('admin.acceuil.tete.form')
                    <center>
