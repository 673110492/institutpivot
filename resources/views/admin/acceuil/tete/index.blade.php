...
<div class="card">
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0">Liste des en tetes pour la page d'accueil</h5>
            </div>
            <div class="col-auto align-self-center" style="margin-right: 20px">
                <h5>Total : {{$tetes->count()}}</h5>
            </div>
                            ...
                            <div class="card-body p-0 pb-3">
                                <div class="d-flex align-items-center justify-content-end my-3">
                                    <div id="bulk-select-replace-element" style="margin-right: 20px">
                                        <button title="Ajout d'une en tete"  data-bs-toggle="modal" data-bs-target="#ajouttete"  class="btn btn-falcon-success btn-sm">
                                                ...
                                                <tr class="btn-reveal-trigger">
                                                    ...
                                                    <td class="align-middle mr-20">
                                                        <button class="btn btn-falcon-info me-1 mb-1"
                                                            title="Détail d'une en tete"  data-bs-toggle="modal"
                                                            data-bs-target="#detailtete{{ $item->id }}" type="button"><i
                                                                class="fa fa-eye"></i></button>
                                                        <button class="btn btn-falcon-primary me-1 mb-1" title="Modifier une en tete" data-bs-toggle="modal"
                                                                data-bs-target="#edittete{{ $item->id }}"
                                                                type="button"><i class="fa fa-pen"></i>
                                                        </button>
                                                        <button class="btn btn-falcon-danger me-1 mb-1" title="Supprimer une en tete"
                                                        ...
                                                        'id' => $item->id,
                                                        'url' => route('tete.delete', $item->id),
                                                        ])
                                                        @include('admin.acceuil.tete.statut', [
                                                            'tete' => $item,
                                                            'url' => route('tete.statut', $item->id),
                                                        ])

                                                    @include('admin.acceuil.tete.edit', [
                                                        'tete'  => $item,
                                                    ])
                                                    @include('admin.acceuil.tete.show', [
                                                        'tete'  => $item,
                                                    ])
                                                    </td>
                                                </tr>
    ...
    {{-- MODAL CREATE --}}
    @include('admin.acceuil.tete.create')
@endsection
