<div class="modal fade" id="editfiche{{ $fiche->id }}" data-bs-keyboard="false" data-bs-backdrop="static"
        ...
        <div class="modal-content border-0">
            ...
            <div class="modal-body p-0">
                ...
                <div class="bg-light rounded-top-lg py-3 ps-4 pe-6">
                    <h4 class="mb-1" id="editfiche{{ $fiche->id }}Label">Modification d'une fiche
                    </h4>
                    {{-- <p class="fs--2 mb-0">Added by <a class="link-600 fw-semi-bold" href="#!">Antony</a></p> --}}
                </div>


                <form method="POST" action="{{ route('fiche.update', $fiche->id) }}" accept-charset="UTF-8"
                    class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    @include('admin.fiche_pre_inscription.form')
                    <center>
