...
<div class="card mb-3">
    ...
    <div class="card-body position-relative">
        <div class="row">
            <div class="col-lg-8">
                <h3>Gestion des fiches de pré-inscription</h3>
...
<div class="card">
                            ...
                            <div class="card-body p-0 pb-3">
                                <div class="d-flex align-items-center justify-content-end my-3">
                                    <div id="bulk-select-replace-element" style="margin-right: 20px">
                                        <button title="Ajout d'une fiche"  data-bs-toggle="modal" data-bs-target="#ajoutfiche"  class="btn btn-falcon-success btn-sm">
                                        ...
                                        <table class="table table-striped mb-0 fs--3 overflow-hidden">
                                            ...
                                            <tbody class="list" id="table-orders-body">
                                                ...
                                                <tr class="btn-reveal-trigger">
                                                    ...
                                                    {{-- <td class="align-middle nom">{!! Str::limit($item->nom, 15, '...')  !!}</td> --}}
                                                    <td class="align-middle nom">{{$item->nom}}</td>
                                                    ...
                                                    <td class="align-middle mr-20">
                                                        <button class="btn btn-falcon-primary me-1 mb-1" title="Modifier une fiche" data-bs-toggle="modal"
                                                                data-bs-target="#editfiche{{ $item->id }}"
                                                                type="button"><i class="fa fa-pen"></i>
                                                        </button>
                                                        <button class="btn btn-falcon-danger me-1 mb-1" title="Supprimer une fiche"
                                                        ...
                                                        'id' => $item->id,
                                                        'url' => route('fiche.delete', $item->id),
                                                        ])
                                                        @include('admin.fiche_pre_inscription.statut', [
                                                            'fiche' => $item,
                                                            'url' => route('fiche.statut', $item->id),
                                                        ])

                                                    @include('admin.fiche_pre_inscription.edit', [
                                                        'fiche'  => $item,
                                                    ])
    ...
    {{-- MODAL CREATE --}}
    @include('admin.fiche_pre_inscription.create')
@endsection
