<div class="tab-content">
    <div class="tab-pane preview-tab-pane active" role="tabpanel"
        ...
        <div class="modal fade" id="ajoutfiche" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1"
                ...
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-0">
                        ...
                        <div class="bg-light rounded-top-lg py-3 ps-4 pe-6">
                            <h4 class="mb-1" id="ajoutAbonnement">Ajouter une nouvelle fiche</h4>
                            {{-- <p class="fs--2 mb-0">Added by <a class="link-600 fw-semi-bold" href="#!">Antony</a></p> --}}
                        </div>


                        <form method="POST" action="{{ route('fiche.store') }}" accept-charset="UTF-8"
