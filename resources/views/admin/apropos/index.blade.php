                            ...
                            <div class="card-body p-0 pb-3">
                                <div class="d-flex align-items-center justify-content-end my-3">
                                    <div id="bulk-select-replace-element" style="margin-right: 20px">
                                        <a title="Ajout d'une information" href="{{route('apropos.create')}}"  class="btn btn-falcon-success btn-sm">
                                        ...
                                        <table class="table table-striped mb-0 fs--3 overflow-hidden">
                                            <thead class="bg-200 text-900">
                                                <tr>
                                                    ...
                                                    <th class="align-middle" data-sort="nom">Contenu</th>
                                            ...
                                            <tbody class="list" id="table-orders-body">
                                                ...
                                                <tr class="btn-reveal-trigger">
                                                    ...
                                                    <td class="align-middle nom">{!! Str::limit($item->contenu, 30, '...')  !!}</td>
                                                    ...
                                                    <td class="align-middle mr-20">
                                                        ...
                                                        <a class="btn btn-falcon-primary me-1 mb-1" href="{{route('apropos.edit',$item->id)}}" title="Modifier une information"><i class="fa fa-pen"></i>
                                                        </a>
                                                        ...
                                                        'id' => $item->id,
                                                        'url' => route('apropos.delete', $item->id),
                                                        ])
                                                        @include('admin.apropos.statut', [
                                                            'apropos' => $item,
                                                            'url' => route('apropos.statut', $item->id),
                                                        ])
                                                    @include('admin.apropos.show', [
                                                        'apropos'  => $item,
                                                    ])
                                                    </td>
                                                </tr>
