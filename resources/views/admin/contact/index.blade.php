...
<div class="card mb-3">
    ...
    <div class="card-body position-relative">
        <div class="row">
            <div class="col-lg-8">
                <h3>Gestion du contact</h3>
                <p class="mb-0"><a href="{{ url('/home') }}">Dashboard</a> / Contact</p>
            </div>
            <br>
            <div class="col-12">
                @if ($errors->any())
    ...
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0">Liste des differentes informations</h5>
            </div>
            <div class="col-auto align-self-center" style="margin-right: 20px">
                <h5>Total : {{$contacts->count()}}</h5>
            </div>
                            ...
                            <div class="card-body p-0 pb-3">
                                <div class="d-flex align-items-center justify-content-end my-3">
                                    <div id="bulk-select-replace-element" style="margin-right: 20px">
                                        <button title="Ajout d'une information"  data-bs-toggle="modal" data-bs-target="#ajoutcontact"  class="btn btn-falcon-success btn-sm">
                                        ...
                                        <table class="table table-striped mb-0 fs--3 overflow-hidden">
                                            <thead class="bg-200 text-900">
                                                <tr>
                                                    ...
                                                    <th class="align-middle" data-sort="nom">Adresse</th>
                                                    <th class="align-middle" data-sort="sexe">Telephone</th>
                                                    <th class="align-middle" data-sort="sexe">Email</th>
                                                    <th class="align-middle" data-sort="sexe">Site web</th>
                                            ...
                                            <tbody class="list" id="table-orders-body">
                                                ...
                                                <tr class="btn-reveal-trigger">
                                                    ...
                                                    <td class="align-middle nom">{!! Str::limit($item->adresse, 30, '...')  !!}</td>
                                                    <td class="align-middle nom">{{$item->tel}}</td>
                                                    <td class="align-middle nom">{!! Str::limit($item->email, 10, '...')  !!}</td>
                                                    <td class="align-middle nom">{{$item->site}}</td>
                                                    ...
                                                    <td class="align-middle mr-20">
                                                        <button class="btn btn-falcon-info me-1 mb-1"
                                                            title="Détail d'une information"  data-bs-toggle="modal"
                                                            data-bs-target="#detailcontact{{ $item->id }}" type="button"><i
                                                                class="fa fa-eye"></i></button>
                                                        <button class="btn btn-falcon-primary me-1 mb-1" title="Modifier une information" data-bs-toggle="modal"
                                                                data-bs-target="#editcontact{{ $item->id }}"
                                                                type="button"><i class="fa fa-pen"></i>
                                                        </button>
                                                        <button class="btn btn-falcon-danger me-1 mb-1" title="Supprimer une information"
                                                        ...
                                                        'id' => $item->id,
                                                        'url' => route('contact.delete', $item->id),
                                                        ])
                                                        @include('admin.contact.statut', [
                                                            'contact' => $item,
                                                            'url' => route('contact.statut', $item->id),
                                                        ])
