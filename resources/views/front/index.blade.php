...
@section('content')
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-xl-7 col-md-86">
                    <div class="course_details_iner">
                        <div class="single_course_list" data-aos="fade-up" data-aos-duration="1200">
                            <img src="img/icon/course_1.svg" alt="">
                            <h4>Admission</h4>
                            <p style="text-align:justify">Admission possible et ouverte pendant toute l’année.</p>
                        </div>
                        <div class="single_course_list" data-aos="fade-up" data-aos-duration="1600">
                            <img src="img/icon/course_2.svg" alt="">
                            <h4>Cours en ligne</h4>
                            <p style="text-align:justify">Travailler de la maison, du bureau, de n’importe où a votre rythme
                                .</p>
                        </div>
                        <div class="single_course_list" data-aos="fade-up" data-aos-duration="2000">
                            <img src="img/icon/course_3.svg" alt="">
                            <h4>Diplômes</h4>
                            <p style="text-align:justify">Diplômes reconnus au niveau National et International (DQP, CQP,
                                Attestation ministérielle), Certifications internationales.</p>
                        </div>
                        <div class="single_course_list" data-aos="fade-up" data-aos-duration="2400">
                            <img src="img/icon/course_4.svg" alt="">
                            <h4>Carrières</h4>
                            <p style="text-align:justify">Le digital s’intègre dans tout corps de métier (Développeur web et
                                mobile, Administrateur réseau, ...).</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="course_registration">
                        <div class="course_registration_form">
                            ...
                            <form method="POST" action="{{ route('preinscription.store') }}" enctype="multipart/form-data">
                                ...
                                <select onchange="change()" id="type_formation_id" name="type_formation_id"
                                    class="niceSelect">
                        ...
                        <img src="img/animated_icon/cources_details_bg.png" alt="#"
                            class="custom-animation1 cources_details_bg">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-xl-5 col-md-6" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="700">
                    <div class="about_us_img">
                        <img src="{{ isset($about) ? url('storage/' . $about->photo) : '#' }}" alt="#"
                            class="img-fluid">
                ...
                <div class="col-xl-6 col-md-6" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="700">
                    <div class="about_us_details">
                        <span
                            style="color:black; font-size: 2.5em;"><b>{{ isset($about->titre) ? $about->titre : 'A Propos De Nous' }}</b></span>
                        <p style="text-align: justify">{{ isset($about->contenu) ? $about->contenu : 'Notre vison' }}</p>
                        <h3><span>Contacts </span>+237 659218936 / institutpivot@gmail.com</h3>
                    ...
                    <div class="popular_courses_item owl-carousel">
                        @foreach ($formations as $item)
                            <div data-aos="fade-up" data-aos-duration="1200" class="single_courses_item">
                                <a href="{{ route('cours.show', $item->id) }}"><img
                                        src="{{ isset($item->photo) ? url('storage/' . $item->photo) : '#' }}"
                                        alt="#" height="250"></a>
                                <div class="courses_item_iner">
                                    ...
                                    <a href="{{ route('cours.show', $item->id) }}">
                                        <h4 class="text-primary" style="font-weight: bold">{{ $item->nom }}</h4>
                                    </a>
    ...
    <section class="about_us section_padding" style="background-color: #E3E3E3;">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-xl-5 col-md-6" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="700">
                    <div class="about_us_img">
                        <img src="{{ isset($actualite) ? url('storage/' . $actualite->photo) : '#' }}" alt="#"
                            class="img-fluid">
                        <!-- <img src="{{ isset($actualite) ? url('storage/' . $actualite->photo) : '#' }}" alt="#" class="img-fluid"> -->
                        <div class="about_tricker">
                            <div class="tricker_iner">
                                <p>Nos <br><b style="font-size: 1.5em;">ACTUALIER</b></p>
                            </div>
                        </div>
                        <img src="img/animated_icon/about_icon.png" alt="#" class="about_icon custom-animation">
                    </div>
                ...
                <div class="col-xl-6 col-md-6" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="700">
                    <div class="about_us_details">
                        <span
                            style="color:black; font-size: 2.5em;"><b>{{ isset($actualite->titre) ? $actualite->titre : 'ACTUALITER' }}</b></span>
                        <p style="text-align: justify">
                            {{ isset($actualite->message) ? $actualite->message : 'Notre vison' }}</p>
                        <a href="{{ route('cours.index') }}" class="btn_1">Voir les formations</a>
                    </div>
                </div>
            </div>
    ...
    <section id="nos-partenaires" class="section" style="padding: 60px 0; background-color: #fff;">
        <div class="container">
            <h2 class="section-title" style="text-align: center; font-size: 36px; font-weight: bold; margin-bottom: 40px; color: #333;">
                Nos Partenaires
            </h2>
            <div class="partenaires-container" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 0; justify-items: center;">
                <!-- Vérification si des partenaires sont récupérés -->
                @if($partenaire->isEmpty())
                    <p>Aucun partenaire actif disponible.</p>
                @else
                    <!-- Boucle à travers les partenaires récupérés -->
                    @foreach($partenaire as $partenaire)
                        <div class="partenaire" style="text-align: center; margin: 0;">
                            <img src="{{ url('storage/' . $partenaire->image) }}" alt="Partenaire"
    ...
    <script>
        // Script pour l'effet de survol
        const partenairesImages = document.querySelectorAll('.partenaire img');

        partenairesImages.forEach(image => {
                        ...
                        @foreach ($temoignages as $item)
                            <div class="single_student_review">
                                ...
                                <div class="student_review_content">
                                    <img src="{{ isset($item->photo) ? url('storage/' . $item->photo) : '#' }}"
                                        alt="">
                    ...
                    <div class="motivation_content">
                        ...
                        <ul class="nav nav-tabs" id="motivation_content_tab" role="tablist">
                            @foreach ($formations->take(3) as $item)
                                <li class="nav-item">
                                    <a class="nav-link single_item" data-toggle="tab" href="#Design" role="tab"
                                        aria-selected="true" id="Design-tab" data-aos="fade-up" data-aos-duration="700">
        ...
        <div class="tab-content" id="motivation_content_tabcontent">
            <div class="tab-pane fade show active" id="Design" role="tabpanel" aria-labelledby="Design-tab">
                <div class="motivation_video">
                    <a href="{{ isset($video) ? url('storage/' . $video->video) : '#' }}"
                        class="animated_play_button popup_youtube">
